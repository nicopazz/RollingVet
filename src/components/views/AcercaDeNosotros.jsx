    ...
    return (
        <Container className="mainSection my-5">
            <div className="text-center mb-5">
                <h1 className="display-4 fw-bold text-primary">Equipo de desarrollo</h1>
                <p className="lead text-secondary">
                    Conoce a los profesionales que desarrollaron de RollingVet.
                </p>
            </div>
            ...
            <div className="bg-light p-5 rounded-3 mt-5 text-center">
                ...
                <p>Siempre estamos buscando talento comprometido con el desarrollo de nuestra app.</p>
