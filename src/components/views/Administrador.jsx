    ...
    <Container fluid className="p-0 overflow-hidden">
      <Row className="g-0">
        <Col
          md={3}
          lg={2}
          className="bg-light min-vh-100 text-dark d-flex flex-column py-4 shadow sticky-top"
          style={{ height: "100vh" }}
        >
          <div className="text-center mb-5 px-2">
            <h4 className="fw-bold text-dark letter-spacing-2">
              ADMINISTRACION
            </h4>
          ...
          <Nav className="flex-column px-2 gap-2">
            ...
            <Button
              variant={vistaActiva === "productos" ? "info" : "outline-info"}
              className="text-start border-0 py-3 px-4 rounded-3 d-flex align-items-center text-dark"
            ...
            <Button
              ...
              className={`text-start border-0 py-3 px-4 rounded-3 d-flex align-items-center ${
                vistaActiva === "pacientes" ? "text-dark" : "text-dark"
              }`}
            ...
            <Button
              variant={
                vistaActiva === "profesionales" ? "info" : "outline-info"
              }
              className="text-start border-0 py-3 px-4 rounded-3 d-flex align-items-center text-dark"
